...
var G__41227 = o;
(G__41227[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__41228__delegate = function (args){
...
while (G__41229__i < G__41229__a.length) {G__41229__a[G__41229__i] = arguments[G__41229__i + 0]; ++G__41229__i;}
  args = new cljs.core.IndexedSeq(G__41229__a,0,null);
} 
return G__41228__delegate.call(this,args);};
G__41228.cljs$lang$maxFixedArity = 0;
G__41228.cljs$lang$applyTo = (function (arglist__41230){
var args = cljs.core.seq(arglist__41230);
return G__41228__delegate(args);
});
...
var G__41231 = o;
(G__41231[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__41233__i < G__41233__a.length) {G__41233__a[G__41233__i] = arguments[G__41233__i + 0]; ++G__41233__i;}
  args = new cljs.core.IndexedSeq(G__41233__a,0,null);
} 
...
var G__41236 = props;
var G__41236__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__41236,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41236);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__41236__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__41237){
...
var class$ = cljs.core.get.call(null,map__41238__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__41240){
...
var on_write = cljs.core.get.call(null,map__41241__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__41241,map__41241__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__41241,map__41241__$1,on_write))
);
} else {
...
var G__41244 = jsprops;
(G__41244["defaultValue"] = value);

(G__41244["onChange"] = ((function (G__41244,v,value,on_change){
return (function (p1__41243_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__41243_SHARP_);
});})(G__41244,v,value,on_change))
);
...
var vec__41247 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__41247,(0),null);
var id = cljs.core.nth.call(null,vec__41247,(1),null);
var class$ = cljs.core.nth.call(null,vec__41247,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___41251 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___41251 == null)){
} else {
var key_41252 = temp__5724__auto___41251;
(jsprops["key"] = key_41252);
}
...
var temp__5724__auto___41253 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___41253 == null)){
} else {
var key_41254 = temp__5724__auto___41253;
reagent.impl.template.oset.call(null,jsprops,"key",key_41254);
}
...
var G__41255 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__41255["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq41259){
var G__41260 = cljs.core.first.call(null,seq41259);
var seq41259__$1 = cljs.core.next.call(null,seq41259);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41260,seq41259__$1);
});
...
break;
default:
var G__41266 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__41266;
continue;
...
var n__4607__auto___41268 = a.length;
var i_41269 = (0);
while(true){
if((i_41269 < n__4607__auto___41268)){
(a[i_41269] = reagent.impl.template.as_element.call(null,(a[i_41269])));

var G__41270 = (i_41269 + (1));
i_41269 = G__41270;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___41271 = a.length;
var i_41272 = (0);
while(true){
if((i_41272 < n__4607__auto___41271)){
var val_41273 = (a[i_41272]);
if(((cljs.core.vector_QMARK_.call(null,val_41273)) && ((reagent.impl.template.key_from_vec.call(null,val_41273) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_41272] = reagent.impl.template.as_element.call(null,val_41273));

var G__41274 = (i_41272 + (1));
i_41272 = G__41274;
continue;
} else {
}
...
var ctx = ({});
var vec__41275 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__41275,(0),null);
var derefed = cljs.core.nth.call(null,vec__41275,(1),null);
...
var G__41278 = (cljs.core.count.call(null,argv) - first_child);
switch (G__41278) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__41278){
...
//# sourceMappingURL=template.js.map?rel=1583319093733
