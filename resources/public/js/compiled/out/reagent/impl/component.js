...
if((i < len)){
var k = (ks[i]);
var G__41173 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__41174 = (i + (1));
m = G__41173;
i = G__41174;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__41176 = c;
var G__41176__$1 = (((G__41176 == null))?null:G__41176.prototype);
if((G__41176__$1 == null)){
return null;
} else {
return (G__41176__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__41178 = c;
var G__41178__$1 = (((G__41178 == null))?null:G__41178.prototype);
if((G__41178__$1 == null)){
return null;
} else {
return (G__41178__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__41181__delegate = function (args){
...
while (G__41182__i < G__41182__a.length) {G__41182__a[G__41182__i] = arguments[G__41182__i + 0]; ++G__41182__i;}
  args = new cljs.core.IndexedSeq(G__41182__a,0,null);
} 
return G__41181__delegate.call(this,args);};
G__41181.cljs$lang$maxFixedArity = 0;
G__41181.cljs$lang$applyTo = (function (arglist__41183){
...
var _STAR_current_component_STAR__orig_val__41185 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41186 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41186;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41185;
}});
...
return ((function (G__41187,G__41187__$1){
...
var c = this;
var G__41188_41190 = (c["cljsRatom"]);
if((G__41188_41190 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__41188_41190);
}
...
var renders_41192 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_41193 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_41192));
if((cljs.core.count.call(null,renders_41192) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_41192))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_41193)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_41193)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__41191 = name;
switch (G__41191) {
case "":
...
var G__41195 = o;
(G__41195[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__41196 = fiber;
var G__41196__$1 = (((G__41196 == null))?null:(G__41196["type"]));
if((G__41196__$1 == null)){
return null;
} else {
return (G__41196__$1["displayName"]);
}
})();
var parent = (function (){var G__41197 = fiber;
if((G__41197 == null)){
return null;
} else {
return (G__41197["return"]);
}
})();
var path = (function (){var G__41198 = parent;
var G__41198__$1 = (((G__41198 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__41198));
if((G__41198__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41198__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__41200 = c;
if((G__41200 == null)){
return null;
} else {
return (G__41200["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__41201._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__41203 = c;
if((G__41203 == null)){
return null;
} else {
return (G__41203["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__41205 = c;
if((G__41205 == null)){
return null;
} else {
return G__41205._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__41207 = instance;
if((G__41207 == null)){
return null;
} else {
return (G__41207["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__41208 = instance;
if((G__41208 == null)){
return null;
} else {
return G__41208._currentElement;
}
}
})();
var name = (function (){var G__41209 = elem;
var G__41209__$1 = (((G__41209 == null))?null:(G__41209["type"]));
if((G__41209__$1 == null)){
return null;
} else {
return (G__41209__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__41211 = elem;
if((G__41211 == null)){
return null;
} else {
return (G__41211["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__41212._owner;
}
}
})();
var path = (function (){var G__41213 = owner;
var G__41213__$1 = (((G__41213 == null))?null:reagent.impl.component.component_path.call(null,G__41213));
if((G__41213__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41213__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__41214 = c;
var G__41214__$1 = (((G__41214 == null))?null:G__41214.constructor);
if((G__41214__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__41214__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1583319093609
