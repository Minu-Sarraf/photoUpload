...
return (new CustomEvent(event_name,(function (){var obj44964 = ({"detail":data});
return obj44964;
})()));
} else {
...
var f = (function (){var pred__44971 = cljs.core._EQ_;
var expr__44972 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44971.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44972))){
return ((function (pred__44971,expr__44972){
return (function (p1__44965_SHARP_){
return console.warn(p1__44965_SHARP_);
});
;})(pred__44971,expr__44972))
} else {
if(cljs.core.truth_(pred__44971.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44972))){
return ((function (pred__44971,expr__44972){
return (function (p1__44966_SHARP_){
return console.debug(p1__44966_SHARP_);
});
;})(pred__44971,expr__44972))
} else {
if(cljs.core.truth_(pred__44971.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44972))){
return ((function (pred__44971,expr__44972){
return (function (p1__44967_SHARP_){
return console.error(p1__44967_SHARP_);
});
;})(pred__44971,expr__44972))
} else {
return ((function (pred__44971,expr__44972){
return (function (p1__44968_SHARP_){
return console.log(p1__44968_SHARP_);
});
;})(pred__44971,expr__44972))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44975){
...
var opts = map__44976__$1;
var eval_fn = cljs.core.get.call(null,map__44976__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44978_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__44980,(0),null);
var v = cljs.core.nth.call(null,vec__44980,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1583319096550
