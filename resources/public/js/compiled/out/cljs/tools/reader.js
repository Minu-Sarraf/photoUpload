...
var G__41500 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__41500;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__41501 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41501,ch);
...
if(("\\" === ch__$1)){
var ch_41502__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_41502__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_41502__$2);
} else {
}

var G__41503 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__41503;
continue;
}
}
...
var vec__41511 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41511,(0),null);
var start_column = cljs.core.nth.call(null,vec__41511,(1),null);
...
var G__41514 = cljs.core.conj_BANG_.call(null,a,form);
a = G__41514;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__41515 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__41516 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__41516;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__41515;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41517 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41517,(0),null);
var start_column = cljs.core.nth.call(null,vec__41517,(1),null);
...
var vec__41520 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41520,(0),null);
var end_column = cljs.core.nth.call(null,vec__41520,(1),null);
...
var vec__41523 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41523,(0),null);
var start_column = cljs.core.nth.call(null,vec__41523,(1),null);
...
var vec__41526 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41526,(0),null);
var end_column = cljs.core.nth.call(null,vec__41526,(1),null);
...
var vec__41529 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41529,(0),null);
var start_column = cljs.core.nth.call(null,vec__41529,(1),null);
...
var vec__41532 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41532,(0),null);
var end_column = cljs.core.nth.call(null,vec__41532,(1),null);
...
var sb = (function (){var G__41535 = (new goog.string.StringBuffer());
G__41535.append(initch);
...
var G__41537 = (function (){var G__41536 = sb;
G__41536.append(ch);

return G__41536;
})();
var G__41538 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41537;
ch = G__41538;
continue;
}
...
switch (G__41541) {
case "\\":
var G__41545 = (function (){var G__41542 = sb;
G__41542.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__41542;
})();
var G__41546 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41545;
ch = G__41546;
continue;
...
break;
default:
var G__41547 = (function (){var G__41543 = sb;
G__41543.append(ch);

return G__41543;
})();
var G__41548 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41547;
ch = G__41548;
continue;
...
var vec__41549 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41549,(0),null);
var end_column = cljs.core.nth.call(null,vec__41549,(1),null);
...
var vec__41552 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41552,(0),null);
var column = cljs.core.nth.call(null,vec__41552,(1),null);
...
var vec__41557 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41557,(0),null);
var column = cljs.core.nth.call(null,vec__41557,(1),null);
...
var vec__41562 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41562,(0),null);
var column = cljs.core.nth.call(null,vec__41562,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__41567 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41567,(0),null);
var start_column = cljs.core.nth.call(null,vec__41567,(1),null);
...
var vec__41570 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41570,(0),null);
var end_column = cljs.core.nth.call(null,vec__41570,(1),null);
...
var G__41573 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__41573,true,null,opts,pending_forms);
...
var G__41574 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__41574)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__41574)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__41574)){
...
var _STAR_suppress_read_STAR__orig_val__41575 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41576 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41576;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41575;
}});
...
var G__41577 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__41577,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__41577,rdr,first_line);
...
var G__41581 = matched;
var G__41582 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__41581;
finished = G__41582;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__41583 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41584 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41584;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41583;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__41585 = cljs.tools.reader.arg_env;
var arg_env_temp_val__41586 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__41586;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__41587 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41587,"(");
...
var G__41588 = (i + (1));
var G__41589 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__41585;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__41590 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__41590);
...
var G__41591 = cljs.core.next.call(null,s__$1);
var G__41592 = ret;
s__$1 = G__41591;
r = G__41592;
continue;
...
var G__41593 = cljs.core.next.call(null,s);
var G__41594 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__41593;
key_vals = G__41594;
continue;
} else {
...
var gensym_env_orig_val__41598 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__41599 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__41599;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__41598;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__41600 = token;
var G__41600__$1 = (((G__41600 == null))?null:cljs.core.subs.call(null,G__41600,(1)));
var G__41600__$2 = (((G__41600__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41600__$1));
var G__41600__$3 = (((G__41600__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41600__$2));
var G__41600__$4 = (((G__41600__$3 == null))?null:cljs.core.symbol.call(null,G__41600__$3));
if((G__41600__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__41600__$4);
}
})():(function (){var G__41601 = token;
var G__41601__$1 = (((G__41601 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41601));
if((G__41601__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41601__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41612,reader){
...
var opts = map__41613__$1;
var eof = cljs.core.get.call(null,map__41613__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1583319094343
